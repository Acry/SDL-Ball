...
#define BRICKS_TOP_BORDER (0.74f)
#define BRICKS_BOTTOM_BORDER (-0.56f)

#define NUM_BRICKS_X 26
#define NUM_BRICKS_Y 23

#define BRICK_WIDTH (PLAYFIELD_WIDTH / NUM_BRICKS_X)
#define BRICK_HEIGHT ((BRICKS_TOP_BORDER - BRICKS_BOTTOM_BORDER) / NUM_BRICKS_Y)
