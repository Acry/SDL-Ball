...
def generate_html(classes):
    ...
    <body>
        ...
        const simulation = d3.forceSimulation()
            ...
            .alphaDecay(0.01) // Langsamerer Abfall der Simulation
            .alphaMin(0.001)  // Niedrigerer Mindestwert für Alpha
            .velocityDecay(0.3); // Geringerer Geschwindigkeitsabfall
        ...
        simulation
            .nodes(nodes)
            .on("tick", ticked)
            .alpha(1)    // Startwert für Alpha
            .restart();  // Neustart der Simulation
