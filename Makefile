...
SOURCES := $(addprefix $(SOURCE_DIR), Display.cpp main.cpp ConfigFileManager.cpp SettingsManager.cpp TtfLegacyGl.cpp SaveFileManager.cpp SoundManager.cpp ThemeManager.cpp Texture.cpp game_state.cpp Score.cpp Background.cpp TextureManager.cpp Speedometer.cpp Paddle.cpp Tracer.cpp)
