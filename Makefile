...
SOURCES := $(addprefix $(SOURCE_DIR), display.cpp main.cpp config_file.cpp settings_manager.cpp text.cpp SaveFileManager.cpp sound.cpp ThemeManager.cpp texture.cpp)
